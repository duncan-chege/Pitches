...
class PitchForm(FlaskForm):
    category= StringField('Category title',validators=[InputRequired()], render_kw={"placeholder": "Enter industry related fields e.g technology, agriculture, entertainment, etc"})
